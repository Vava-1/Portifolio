...
Day to day, I build e-commerce platforms, school and hospital systems, employment platforms, a tourism guide for my own country, and AI agents that actually do work on their own instead of waiting for someone to click a button. I work across the stack — Next.js and React on the frontend, Node.js and Hono and Python on the backend, and whatever AI model makes sense for the job.
...
export const SKILLS = [
  {
    ...
    items: ['LLM application architecture', 'Prompt & context engineering', 'Voice AI (ASR/TTS pipelines)', 'Multi-agent autonomous systems', 'RAG & semantic search (pgvector)', 'Claude, Gemini, GPT-4o, Groq', 'Whisper & XTTS for Kinyarwanda'],
  },
  {
    category: 'Full-Stack Engineering',
    items: ['Next.js 16 / React 19', 'Node.js, Hono & Express', 'Python / FastAPI & Celery', 'PostgreSQL, MySQL, Drizzle & Prisma', 'tRPC v11, REST & WebSockets', 'JWT, OAuth 2.0 & bcrypt'],
  },
  {
    category: 'Infrastructure & Deployment',
    items: ['Vercel', 'Railway', 'Render', 'Cloudflare Workers', 'Docker & Docker Compose', 'GitHub Actions CI/CD', 'Database design'],
  },
  {
    category: 'Product & Direction',
    items: ['System design for real businesses', 'E-commerce & multi-tenant platforms', 'AI agent orchestration', 'Client-facing technical leadership', 'Mobile Money (MTN MoMo, Flutterwave, Airtel)'],
  },
];
...
export const PROJECTS = [
  {
    ...
    role: 'Built it myself — full stack + AI agents',
    summary: 'E-commerce platform for Rwanda\'s second-largest supermarket chain. Nine branches, real products, real Mobile Money payments, and four AI agents that run on their own schedule.',
  ...
  },
  {
    ...
    role: 'Built it myself — full stack + AI concierge',
  ...
  },
  {
    ...
    role: 'Built it myself — multi-agent architecture',
  ...
  },
  {
    ...
    role: 'Built it myself — full stack + AI tutor',
  ...
  },
  {
    ...
    description: 'I built this on spec. No contract, no brief — I just looked at Sulfo Rwanda Industries, a 60-year-old manufacturer with no online presence, and decided to show them what was possible. Full storefront, real product catalog (laundry soap, toilet soap, body care, NIL drinking water), persistent cart, coupon codes, 3-step checkout with MTN MoMo / Card / Cash on Delivery, customer order tracking with live status, and a full admin dashboard. JWT auth. 100% real Sulfo branding (deep green + gold). They didn\'t ask for it. I just built it and sent them the link.',
  ...
  },
  {
    ...
    role: 'Built it myself — full stack',
    summary: 'I wanted to build Rwanda\'s #1 employment platform, so I did. Job board, candidate dashboard, employer pipeline, post-a-job with payment — the whole flow.',
    description: 'I wanted to build Rwanda\'s #1 employment platform, so I did. Job board with filters and search. Candidate dashboard with applications, matches, and alerts. Employer dashboard with pipeline, analytics, and job management. Post-a-job flow with payment. Five-step registration. Social + email sign-in. Toast notifications, modals, a globe visualization. Custom design system with Playfair Display and Inter typography, emerald/blue/gold palette inspired by Rwandan hills. Containerized with Docker and Nginx.',
    stack: ['HTML5', 'Custom CSS design system', 'Vanilla JS modules', 'Docker', 'Nginx', 'Playfair Display + Inter'],
    highlight: 'Full candidate + employer + admin flow — built for Rwanda.',
    link: '',
  ...
  },
  {
    id: 'pbi-academy',
    year: '2025',
    name: 'PBI Academy — Language Learning + Exam Prep',
    role: 'Built it myself — full stack + AI evaluation',
    ...
    highlight: 'AI evaluates speaking and writing using real TOEFL/IELTS rubrics — most platforms fake this.',
    link: '',
  ...
  },
  {
    ...
    description: 'This is the earlier version of the Pacemaker platform — a 300+ file codebase spanning seven academic disciplines. React + Vite frontend, NestJS + Prisma + PostgreSQL backend. Live video classrooms via Agora.io so teachers and students can see each other. AI tutoring via GPT-4 streaming. Real Stripe payments. AWS S3 for content storage. This was the project that taught me how to architect at scale — when you have 300+ files, you either learn to organize or you drown.',
